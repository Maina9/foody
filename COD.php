...
<h2 class="text-center"> Thank you for Ordering at Foody'! The ordering process is now complete.</h2>
...
<h3 class="text-center"> <strong>Your Order Number:</strong> <span style="color: red;"><?php echo "$number"; ?></span> </h3>
